...
getgenv().gagConfig = {
    ...
    SEED_WEBHOOK_URL = "", 
    NOTIFY_PETS = {"Corrupted Kitsune", "Mizuchi", "Kitsune", "Fennec Fox", "Disco Bee", "Raccoon", "Dragonfly", "Butterfly", "Mimic Octopus", "T-Rex", "Spinosaurus", "Red Fox"},
