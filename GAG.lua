...
getgenv().gagConfig = {
    ...
    EQUIP_PETS = {["Tanchozuru"] = 2, ["Starfish"] = 2, "Bald Eagle", ["Capybara"] = 1, ["Seal"] = 4, ["Rooster"] = 2,},
    ...
    SEED_WEBHOOK_URL = "", 
    NOTIFY_PETS = { "Corrupted Kitsune", "Mizuchi", "Kitsune", "Koi", "Fennec Fox", "Disco Bee", "Raccoon", "Dragonfly", "Butterfly", "Mimic Octopus", "T-Rex", "Spinosaurus", "Red Fox"},
